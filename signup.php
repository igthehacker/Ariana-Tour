...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">
     <a href="index.php"><img src="images/icon-5.png" width = "50%"  alt="ariana tour" class="logo img-fluid"></a>
    </div>
     <div class="col-sm-4">
    </div>
  </div>
...
if(!preg_match("/^[A-Za-z _]*[A-Za-z ]+[A-Za-z _]*$/", $lname)){
  ...
  if(!preg_match("/^^[^0-9][a-z0-9]+([_-]?[a-z0-9])*$/", $username)){
            $error[] = 'Invalid Entry for Username. Enter lowercase letters without any space and No number at the start- Eg - myusername, iheb or myusername123';
        }  
