...
<div class="container">
  ...
  <div class="image">
 <a href="index.php"><img src="images/icon-5.png" width = "30%"   alt="ariana tour" class="logo img-fluid"></a> <br>
<?php 
...
<p style="font-size: 12px;text-align: center;margin-top: 10px;"><a href="forgot-password.php" style="color: #00376b;">Forgot Password?(please don't click me i'm not finished D: hihi)</a> </p>
   <br> 
